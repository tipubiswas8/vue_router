  ...
  <div class="admin-layout">
    ...
    <aside class="sidebar" :class="{ 'sidebar-collapsed': isSidebarCollapsed }">
      ...
      <nav class="sidebar-nav">
        <router-link v-for="route in adminRoutes" :key="route.path" :to="route.path" active-class="active">
          <i :class="route.meta.icon"></i>
          <span v-if="!isSidebarCollapsed">{{ route.name }}</span>
        </router-link>
      </nav>
      <router-link style="display: flex; align-items: center; justify-content: center; color: white;"
        class="sidebar-header sidebar-nav" to="/layout-two">Go to Layout Two</router-link>
      <router-link style="display: flex; align-items: center; justify-content: center; color: white;"
...
const userName = 'Admin User' // Replace with real user data
...
// Define your admin routes here or import from your router config
